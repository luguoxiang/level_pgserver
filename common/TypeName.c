...
switch(type){
	...
	case HINT_VALUE:return "HINT_VALUE";
	case BOOL:return "BOOL";
	case APPROXNUM:return "APPROXNUM";
	case NULLX:return "NULLX";
	...
	case IN:return "IN";
	case NOT:return "NOT";
	case COMP_NE:return "COMP_NE";
	case COMP_GE:return "COMP_GE";
	case COMP_GT:return "COMP_GT";
	case COMP_EQ:return "COMP_EQ";
	case COMP_LT:return "COMP_LT";
	case COMP_LE:return "COMP_LE";
	case MOD:return "MOD";
	...
	case NOT_LIKE:return "NOT_LIKE";
	case ALL_ROW:return "ALL_ROW";
	case ALL_COLUMN:return "ALL_COLUMN";
	...
	case IF_EXISTS:return "IF_EXISTS";
